            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a href="{{ route('categories.show.user', ['category' => $category->slug]) }}" class="dropdown-toggle nav-link {{ $isActiveCategory ? 'active' : '' }}" style="{{ $isActiveCategory ? 'color: #E93314;' : '' }}" data-bs-toggle="dropdown">
                            {{ $category->name }}
                        </a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="nav-item dropdown" style="position: relative;">
                                <a href="{{ route('categories.show.user', ['category' => $category->slug]) }}" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                    {{ $category->name }}
                                </a>
                                @if (count($subCategories->where('category_id', $category->id)) > 0)
                                <ul class="dropdown-menu" style="left: 100%; top: 0; margin-top: -6px; position: absolute;">
                                    @foreach ($subCategories->where('category_id', $category->id) as $subCategory)
                                    <li>
                                        <a href="{{ route('news.subcategory', ['slug' => $subCategory->slug]) }}" class="dropdown-item">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                                        ...
                                        <a href="{{ route('logout') }}/login" class="nav-link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" aria-expanded="false">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 512 512">
                                                <path d="M312 372c-7.7 0-14 6.3-14 14 0 9.9-8.1 18-18 18H94c-9.9 0-18-8.1-18-18V126c0-9.9 8.1-18 18-18h186c9.9 0 18 8.1 18 18 0 7.7 6.3 14 14 14s14-6.3 14-14c0-25.4-20.6-46-46-46H94c-25.4 0-46 20.6-46 46v260c0 25.4 20.6 46 46 46h186c25.4 0 46-20.6 46-46 0-7.7-6.3-14-14-14z" fill="currentColor" />
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <a href="/dashboard" class="nav-link d-flex">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="me-1" width="23" height="23" viewBox="0 0 24 24">
                                                <path fill="currentColor" d="M12 12q-1.65 0-2.825-1.175T8 8q0-1.65 1.175-2.825T12 4q1.65 0 2.825 1.175T16 8q0 1.65-1.175 2.825T12 12m-8 8v-2.8q0-.85.438-1.562T5.6 14.55q1.55-.775 3.15-1.162T12 13q1.65 0 3.25.388t3.15 1.162q.725.375 1.163 1.088T20 17.2V20z" />
                                            </svg>
                                            Dashboard
                                        </a>
