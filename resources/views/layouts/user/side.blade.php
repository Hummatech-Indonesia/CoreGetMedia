    ...
    <div style="background-color: #183249;">
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar>
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('profile-user.user' ? 'active' : '') }}"
                        href="{{ route('profile-user.user') }}" aria-expanded="false">
                    ...
                    <a href="{{route('user.history.news')}}" class="sidebar-link">
                        <div class="round-16 d-flex align-items-center justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                                ...
                                <path fill="#ffffff" d="M12.5 7H11v6l5.25 3.15l.75-1.23l-4.5-2.67z" />
                            </svg>
                        </div>
            ...
            {{-- <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('coin.user' ? 'active' : '') }}"
            href="{{route('coin.user')}}" aria-expanded="false">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                <g fill="none">
                    <path
