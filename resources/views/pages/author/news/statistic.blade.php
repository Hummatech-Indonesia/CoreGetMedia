                ...
                <div class="d-flex">
                    <div class="d-flex justify-content-between col-12">
                        <div class="align-items-center justify-content-start text-start">
                            <div>
                                <h4 style="color: #175A95" class=" mb-2">Berita</h4>
                                <h4>{{ $newses->count() }}</h4>
                            </div>
                        </div>
            ...
            <div class="card-body border-1 rounded">
                <div class="d-flex">
                    <div class="d-flex justify-content-between col-12">
                        <div class="align-items-center justify-content-start text-start">
                            <div>
                                <h4 style="color: #175A95" class=" mb-2">Like</h4>
                                <h4>{{ $newsLike }}</h4>
                            </div>
                        </div>
                        <div class="justify-content-between">
            ...
            <div class="card-body border-1 rounded">
                <div class="d-flex">
                    <div class="d-flex justify-content-between col-12">
                        <div class="align-items-center justify-content-start text-start">
                            <div>
                                <h4 style="color: #175A95" class=" mb-2">Pembaca</h4>
                                <h4>{{ $newsView }}</h4>
                            </div>
                        </div>
                        <div class="justify-content-between">
        ...
        <div class="row">
            <div class="col-md-7 col-sm-12">
                <div class="d-flex justify-content-between">
                    <div>
                        <h4>Statistik Berita Terpopuler</h4>
                    </div>
            ...
            <div class="col-md-5 col-sm-12">
                <h4>Berita</h4>
                @forelse ($newsPopulers->take(3) as $news)
                    @php
                        if ($loop->iteration == 1) {
                            $color = 'danger';
                    ...
                    <div class="d-flex gap-3 ms-1 mb-3 mt-4">
                        <div class="my-auto">
                            <span>
                                <div class="badge text-{{ $color }} bg-light-{{ $color }} d-flex justify-content-center align-items-center"
                                    style="font-size: 2rem; width: 50px; height: 50px;">{{ $loop->iteration }}</div>
                            </span>
                        </div>
                        <div class="news-card-three">
                            ...
                            <div class="news-card-info">
                                ...
                                <h4><a href="{{ route('news.singlepost', ['news' => $news->slug]) }}">{{ Str::limit($news->name, 20, '...') }}</a>
                                </h4>
                                <ul class="news-metainfo list-style" style="margin-left: -20px;">
                                    <li><i data-feather="calendar" class="text-danger"></i>
                                        <span style="margin-left: 5px;">{{ \Carbon\Carbon::parse($news->upload_date)->format('M d, Y') }}</span>
                                    </li>
                                    <li><i data-feather="eye" class="text-danger"></i>
                                        <span style="margin-left: 5px;">{{ $news->newsViews()->count() }}x dilihat</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
