...
@section('content')
    ...
    <div class="alert d-flex align-items-center bg-light-primary p-4 border-primary border-1">
        <svg class="ms-4" xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 84 84"
            fill="none">
            <circle cx="42" cy="42" r="40" stroke="#1   75A95 " stroke-width="4" />
        ...
        <div class="d-flex flex-column ms-5">
            ...
            <h6 style="font-weight: 500; font-size:16px; margin-top:3px; color: #175A95">Pastikan anda membaca dibawah ini
                ketentuan & Persyaratan dibawah ini sebelum mengunggah artikel</h6>
            <h6 style="font-weight: 500; font-size:16px; margin-top:10px; color: #175A95">Baca selengkapnya dibawah ini:
            </h6>
    ...
    <form id="myForm" action="{{ route('store.news') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="d-flex justify-content-end">
            <a href="{{ auth()->user()->roles->pluck('name')[0] == 'admin' ? route('news-list.admin') : route('news.list.author') }}"
