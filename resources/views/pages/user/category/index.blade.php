...
<div class="sports-wrap ptb-100">
    ...
    <div class="container">
        ...
        {{-- <div class="mt-4 iklan-top" >
            <img src="{{ asset('assets/img/news/news-11.webp') }}" style="width: 100%; height: 100%; object-fit: cover;" alt="">
        <div style="width: 100%; background-color: rgba(0, 0, 0, 0.5); color: white; text-align: center; padding: 10px; box-sizing: border-box; position: relative; top: -50px;">
            Ingin baca berita tanpa iklan? <a href="#" style="color: yellow; text-decoration: underline;">Berlangganan</a>
        </div>
    </div> --}}
    @endif
