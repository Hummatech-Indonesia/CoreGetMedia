                    ...
                    <div>
                        ...
                        <p class="d-flex gap-1">Share :
                            ...
                            <a id="copylink" tooltip="Salin Link" style="margin-top: 6px; position: relative;">
                                ...
                                <div id="copy-tooltip" class="tooltip-custom">Link copied!</div>
                            </a>
                        </p>
                    </div>
                    <div class="news-img">
                                        ...
                                        <div class="col-md-12 col-lg-3 mb-3">
                                            <li class="author">
                                                ...
                                                <div>
                                                    ...
                                                    <a style="display: inline; text-decoration: none" data-toggle="tooltip" data-placement="top" title="admin" href="#">{{ $news->user->name }}</a>
                                                    @else
                                                    <a style="display: inline; text-decoration: none" data-toggle="tooltip" data-placement="top" title="author - {{ $news->user->name }}" href="{{ route('author.detail', ['author' => $news->user->author->id]) }}">{{ $news->user->name }}</a>
                                                    @endif
