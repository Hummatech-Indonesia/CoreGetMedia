...
<div class="breadcrumb-wrap"
    ...
    <div class="container">
        <h2 class="breadcrumb-title text-white">Pengiklanan</h2>
...
<div class="row" style="margin-block: 100px;">
    <div class="col-lg-12 text-center">
        <h2>Pasang Iklan di GetMedia</h2>
...
<div class="row" style="margin-block: 80px;">
    <div class="col-lg-12 text-center">
        <h2>Tata Cara Pengiklanan di GetMedia</h2>
...
<div class="row justify-content-center gap-4" style="margin-top: 80px; margin-bottom: 30px;">
    <div class="col-lg-4 text-center image-container">
        <div class="text-overlay">
            <div class="number">
                <p style="font-weight: bolder; font-size: 1.2rem;">1</p>
            </div>
            <div class="content">
                <h2 style="color: #434343;">Persiapan</h2>
                <p style="font-size: 1.2rem; margin-block: -2px;">Perlengkapan untuk memasang iklan :</p>
    ...
    <div class="col-lg-4 text-center image-container">
        <div class="text-overlay">
            <div class="number">
                <p style="font-weight: bolder; font-size: 1.2rem;">2</p>
            </div>
            <div class="content">
                <h2 style="color: #434343;">Pengisian Biodata</h2>
                <p style="font-size: 1.2rem; margin-block: -2px; text-align: left;">Pengisian biodata pengiklan, biodata
                    harus di isi
                    dengan benar :</p>
                <ul style="font-size: 1.2rem;">
                    <li>Nama Lengkap</li>
...
<div class="row justify-content-center gap-4" style="margin-top: 40px; margin-bottom: 30px;">
    <div class="col-lg-4 text-center image-container">
        <div class="text-overlay">
            <div class="number">
                <p style="font-weight: bolder; font-size: 1.2rem;">3</p>
            </div>
            <div class="content">
                <h2 style="color: #434343;">Pengisian Iklan</h2>
                <p style="font-size: 1.2rem; margin-block: -2px;">Mengisi form pengiklanan :</p>
                <ul style="font-size: 1.2rem;">
                    <li>Jenis Iklan</li>
                    <li>Pilih Halaman</li>
    ...
    <div class="col-lg-4 text-center image-container">
        <div class="text-overlay">
            <div class="number">
                <p style="font-weight: bolder; font-size: 1.2rem;">4</p>
            </div>
            <div class="content">
                <h2 style="color: #434343;">Pembayaran</h2>
                <p style="font-size: 1.2rem; margin-block: -2px; text-align: left;">Setelah mengisi form pengiklnanan,
                    user dikenakan
...
<div class="row justify-content-center gap-4" style="margin-top: 40px; margin-bottom: 30px;">
    <div class="col-lg-4 text-center image-container">
        <div class="text-overlay">
            <div class="number">
                <p style="font-weight: bolder; font-size: 1.2rem;">5</p>
            </div>
            <div class="content">
                <h2 style="color: #434343;">Menunggu Konfirmasi</h2>
                <p style="font-size: 1.2rem; margin-block: -2px; text-align: left;">Setelah melewati tahap-tahap
    ...
    <div class="col-lg-4 text-center image-container">
        <div class="text-overlay">
            <div class="number">
                <p style="font-weight: bolder; font-size: 1.2rem;">6</p>
            </div>
            <div class="content">
                <h2 style="color: #434343;">Iklan Diunggah</h2>
                <p style="font-size: 1.2rem; margin-block: -2px; text-align: left;">Iklan setelah lolos dari review
                    admin, iklan akan
