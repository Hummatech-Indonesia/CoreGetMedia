    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form-delete" method="post">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label">Hapus data Anda secara permanen?</label>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-rounded btn-light-primary text-primary"
...
<div class="">
    <div class="d-flex justify-content-between">
        <ul class="nav nav-underline" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" style="padding-right: 15px; padding-left: 15px;" id="link3-tab" data-bs-toggle="tab"
                    href="#link3" role="tab" aria-controls="link2">
                    <span>Ditolak</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" style="padding-right: 15px; padding-left: 15px;" id="link4-tab" data-bs-toggle="tab"
                    href="#link4" role="tab" aria-controls="link2">
                    <span>Draft</span>
                </a>
            </li>
        </ul>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 col-lg-2">
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $all_advertisement->image) }}" alt="" width="290px"
                            ...
                            <div class="col-md-12 col-lg-4">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    @elseif (
                                    $all_advertisement->status == 'accepted' && $all_advertisement->feed ==
                                    'notpaid'
                                    )
                                    <div class="d-flex justify-content-end">
                                        <div class="text-md-right">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="button" id="btn-cencel" data-id="{{ $all_advertisement->id }}"
                                ...
                                @elseif (
                                $all_advertisement->status == 'pending' || $all_advertisement->status ==
                                'reject'
                                )
                                <div class="d-flex justify-content-end">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 col-lg-2">
                                <div class="mb-2">
                                    <img src="{{ asset('assets/img/news/news-12.webp') }}" alt="" width="290px"
            height="180px" class="w-100" style="width: 100%; object-fit:cover;">
        </div>
    </div>
    <div class="row col-md-12 col-lg-6">
    ...
    <div class="col-md-12 col-lg-4">
        ...
        <div class="d-flex justify-content-end">
            <button type="submit" class="btn m-1 mt-5 text-white px-4 py-1" style="background-color: #C94F4F;">
                Batalkan
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12 col-lg-2">
                    <div class="mb-2">
                        <img src="{{ asset('assets/img/news/news-12.webp') }}" alt="" width="290px" height="180px"
                            class="w-100" style="width: 100%; object-fit:cover;">
                    </div>
                </div>
                <div class="row col-md-12 col-lg-6">
                    <div class="row col-lg-6">
                ...
                <div class="col-md-12 col-lg-4">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('detail-advertisement') }}" class="btn btn-sm m-1 mt-5"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="30" viewBox="0 0 512 512">
                                <path fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="32"
                                    d="M255.66 112c-77.94 0-157.89 45.11-220.83 135.33a16 16 0 0 0-.27 17.77C82.92 340.8 161.8 400 255.66 400c92.84 0 173.34-59.38 221.79-135.25a16.14 16.14 0 0 0 0-17.47C428.89 172.28 347.8 112 255.66 112" />
                                <circle cx="256" cy="256" r="80" fill="none" stroke="#ffffff" stroke-miterlimit="10"
                                    stroke-width="32" />
                            </svg>
                        </a>
                        ...
                        <form method="POST">
                            @csrf
                            <button type="submit" class="btn btn-sm m-1 mt-5" style="background-color: #C94F4F;"><svg
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 col-lg-2">
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $accepted_advertisement->image) }}" alt="" width="290px"
                                height="180px" class="w-100" style="width: 100%; object-fit:cover;">
                        </div>
                    </div>
                    <div class="row col-md-12 col-lg-6">
                    ...
                    <div class="col-md-12 col-lg-4">
                        ...
                        @if ($accepted_advertisement->feed == 'notpaid')
                        <div class="d-flex justify-content-end">
                            <button type="button" id="btn-cencel" data-id="{{ $accepted_advertisement->id }}"
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 col-lg-2">
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $pending_advertisement->image) }}" alt="" width="290px"
                                height="180px" class="w-100" style="width: 100%; object-fit:cover;">
                        </div>
                    </div>
                    <div class="row col-md-12 col-lg-6">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 col-lg-2">
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $reject_advertisement->image) }}" alt="" width="290px"
                                height="180px" class="w-100" style="width: 100%; object-fit:cover;">
                        </div>
                    </div>
                    <div class="row col-md-12 col-lg-6">
