        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h3 class="modal-title">Batalkan Pengiklanan</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <!-- Modal body -->
                <form id="form-cencel" method="post">
                    @method('DELETE')
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
                            {{-- <label class="form-label">Yakin ingin membatalkan pengiklanan?</label> --}}
                            <p>Yakin ingin membatalkan pengiklanan?</p>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="d-flex justify-content-end gap-2">
                                <button class="btn bg-light-danger text-danger" type="button"
    ...
    <div class="">
        <div class="d-flex justify-content-between">
            <ul class="nav nav-underline" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" style="padding-right: 15px; padding-left: 15px;" id="link3-tab"
                        data-bs-toggle="tab" href="#link3" role="tab" aria-controls="link2">
                        <span>Ditolak</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" style="padding-right: 15px; padding-left: 15px;" id="link4-tab"
                        data-bs-toggle="tab" href="#link4" role="tab" aria-controls="link2">
                        <span>Draft</span>
                    </a>
                </li>
            </ul>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12 col-lg-2">
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $all_advertisement->image) }}" alt=""
                                                width="290px" height="180px" class="w-100"
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="d-flex justify-content-end gap-2">
                                            ...
                                            @elseif ($all_advertisement->status == 'reject' && $all_advertisement->feed == 'notpaid')
                                                <div class="d-flex justify-content-end">
                                                    <div class="text-md-right">
                                                        <button data-description="{{ $all_advertisement->description }}"
                                                            class="btn btn-sm btn-description m-1"
                                            ...
                                            @elseif ($all_advertisement->status == 'accepted' && $all_advertisement->feed == 'notpaid')
                                                <div class="d-flex justify-content-end">
                                                    <div class="text-md-right">
                                                        <span
                                                            class="badge bg-light-danger text-danger fs-4 me-2 px-3 py-2">
                                                            Belum Dibayar
                                                        </span>
                                                    </div>
                                                    <div class="text-md-right">
                                            ...
                                            @elseif ($all_advertisement->status == 'accepted' && $all_advertisement->feed == 'paid')
                                                <div class="d-flex justify-content-end">
                                                    <div class="text-md-right">
                                                        <span
                                                            class="badge bg-light-success text-success fs-4 me-2 px-3 py-2">
                                                            Sudah Dibayar
                                                        </span>
                                                    </div>
                                                    <div class="text-md-right">
                                        ...
                                        @if ($all_advertisement->status == 'accepted' && $all_advertisement->feed == 'notpaid')
                                            <div class="d-flex justify-content-end">
                                                <button type="button" id="btn-cencel"
                                                    data-id="{{ $all_advertisement->id }}"
                                                    class="btn m-1 mt-5 btn-cencel text-white px-4 py-1"
                                                ...
                                                <a href="{{ route('detail-payment-advertisement', ['advertisement' => $all_advertisement->id]) }}"
                                                    class="btn m-1 mt-5 text-white" style="background-color: #5D87FF;">
                                                    Lanjut Pembayaran
                                        ...
                                        @elseif ($all_advertisement->status == 'pending' || $all_advertisement->status == 'reject')
                                            <div class="d-flex justify-content-end">
                                                <a href="{{ route('detail-advertisement', [$all_advertisement->id]) }}"
                                                    class="btn btn-sm m-1 mt-5" style="background-color: #5D87FF;">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="30"
                                                        ...
                                                        <circle cx="256" cy="256" r="80" fill="none"
                                                            stroke="#ffffff" stroke-miterlimit="10" stroke-width="32" />
                                                    </svg>
                                                </a>

                                                <a href="{{ route('show.edit.advertisement', ['id' => $all_advertisement->id]) }}"
                                                    class="btn btn-sm m-1 mt-5" style="background-color: #FFD643;">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23"
                                                        viewBox="0 0 24 24" class="mt-1">
                                                        <path fill="#ffffff"
                                                ...
                                                <button type="button" id="btn-delete"
                                                    data-id="{{ $all_advertisement->id }}"
                                                    class="btn btn-sm m-1 mt-5 btn-delete"
                                                    style="background-color: #C94F4F;"><svg
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12 col-lg-2">
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $accepted_advertisement->image) }}"
                                                alt="" width="290px" height="180px" class="w-100"
                                                style="width: 100%; object-fit:cover;">
                                        </div>
                                    </div>
                                    <div class="row col-md-12 col-lg-6">
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        ...
                                        @if ($accepted_advertisement->feed == 'notpaid')
                                            <div class="d-flex justify-content-end">
                                                <button type="button" id="btn-cencel"
                                                    data-id="{{ $accepted_advertisement->id }}"
                                                    class="btn m-1 mt-5 btn-cencel text-white px-4 py-1"
                                                    style="background-color: #C94F4F;">
                                                    Batalkan
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23"
                                                ...
                                                <a href="#" class="btn m-1 mt-5 text-white"
                                                    style="background-color: #5D87FF;">
                                                    Lanjut Pembayaran
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                        viewBox="0 0 24 24">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12 col-lg-2">
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $pending_advertisement->image) }}"
                                                alt="" width="290px" height="180px" class="w-100"
                                                style="width: 100%; object-fit:cover;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <a href="{{ route('detail-advertisement', [$pending_advertisement->id]) }}"
                                                class="btn btn-sm m-1 mt-5" style="background-color: #5D87FF;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="30"
                                                    viewBox="0 0 512 512">
                                                    <path fill="none" stroke="#ffffff" stroke-linecap="round"
                                            ...
                                            <a href="{{ route('show.edit.advertisement', ['id' => $pending_advertisement->id]) }}"
                                                class="btn btn-sm m-1 mt-5" style="background-color: #FFD643;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23"
                                                    viewBox="0 2 24 24">
                                                    <path fill="#ffffff"
                                            ...
                                            <button type="button" id="btn-delete"
                                                data-id="{{ $pending_advertisement->id }}"
                                                class="btn btn-sm m-1 mt-5 btn-delete"
                                                style="background-color: #C94F4F;"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="23" height="30" viewBox="0 0 512 512">
                                                    <path
                                                        d="M128 405.429C128 428.846 147.198 448 170.667 448h170.667C364.802 448 384 428.846 384 405.429V160H128v245.429zM416 96h-80l-26.785-32H202.786L176 96H96v32h320V96z"
                                                        fill="#ffffff" />
                                                </svg></button>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12 col-lg-2">
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $reject_advertisement->image) }}"
                                                alt="" width="290px" height="180px" class="w-100"
                                                style="width: 100%; object-fit:cover;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        ...
                                        <div class="d-flex justify-content-end gap-2">
                                            <div class="d-flex justify-content-end">
                                                <div class="text-md-right">
                                                    <button data-description="{{ $reject_advertisement->description }}"
                                                        class="btn btn-sm btn-description m-1"
                                                        style="background-color: #5D87FF;">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="23"
                                                            height="20" viewBox="0 0 512 512">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <a href="{{ route('detail-advertisement', ['advertisement' => $reject_advertisement->id]) }}"
                                                class="btn btn-sm m-1 mt-5" style="background-color: #5D87FF;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="30"
                                                    viewBox="0 0 512 512">
                                                    <path fill="none" stroke="#ffffff" stroke-linecap="round"
                                            ...
                                            <button type="button" id="btn-delete"
                                                data-id="{{ $reject_advertisement->id }}"
                                                class="btn btn-sm m-1 mt-5 btn-delete"
                                                style="background-color: #C94F4F;"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="23" height="30" viewBox="0 0 512 512">
                                                    <path
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12 col-lg-2">
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $draft->image) }}" alt=""
                                                width="290px" height="180px" class="w-100"
                                                style="width: 100%; object-fit:cover;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button type="button" id="btn-delete" data-id="{{ $draft->id }}"
                                                class="btn m-1 mt-5 btn-delete text-white px-4 py-1"
                                                style="background-color: #C94F4F;">
                                                Hapus
                                                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23"
                                                    viewBox="0 0 24 24">
                                            ...
                                            <a href="{{ route('show.edit.advertisement', ['id' => $draft->id]) }}"
                                                class="btn m-1 mt-5 text-white" style="background-color: #175A95;">
                                                Lanjut Mengedit
                                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                    viewBox="0 0 24 24">
                                                    <path fill="#ffffff"
