    ...
    <div class="col-lg-4">
        <div class="sidebar">
            <div class="sidebar-widget" style="width: 450px">
                ...
                <ul class="category-widget list-style">
                    {{-- @foreach ($totalCategories as $category)
                        <li><a
                                href="{{ route('categories.show.user', ['category' => $category->slug]) }}"><img src="{{ asset('assets/img/icons/arrow-right.svg') }}" alt="Image">{{ $category->name }}
            ...
            <div class="sidebar-widget" style="width: 450px">
                ...
                <div class="news-card-info">
                    <h3><a data-toggle="tooltip" data-placement="top" title="{{ $popular->name }}" href="{{ route('news.user', ['news' => $popular->slug,'year'=> $dateParts['year'],'month'=>$dateParts['month'],'day'=> $dateParts['day'] ]) }}">{!! Illuminate\Support\Str::limit($popular->name, $limit = 40, $end = '...') !!}</a>
                    </h3>
                    <ul class="news-metainfo list-style">
            ...
            <div class="news-card-one">
                ...
                <div class="news-card-info">
                    <h3><a data-toggle="tooltip" data-placement="top" title="{{ $popularNews->name }}" href="{{ route('news.singlepost', $popularNews->slug) }}">{{ $popularNews->name }}</a>
                    </h3>
