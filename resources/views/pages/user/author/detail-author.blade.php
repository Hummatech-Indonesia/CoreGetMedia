            ...
            <div class="col-lg-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="container mt-4">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <form action="{{ route('unfollow.author', $author->id) }}" method="POST" class="mr-2">
                                    @method('DELETE')
                                    @csrf
                                    <button type="submit" class="btn btn-primary" style="background-color: #175A95; border: none">Batal Ikuti</button>
                                </form>
                                @else
                                <form action="{{ route('follow.author', $author->id) }}" method="POST" class="mr-2">
                                    @method('post')
                                    @csrf
                                    <button type="submit" class="btn btn-primary" style="background-color: #175A95; border: none">
                ...
                <div class=" card-detail mt-4">
                    <div class="card-body">
                        ...
                        <div class="d-flex">
                            @if ($author->user->image != null && Storage::disk('public')->exists($author->user->image))
                            <img src="{{ asset('storage/' . $author->user->image) }}" style="border-radius: 50%;" class="mb-3" style="object-fit: cover" width="50" height="50">
                            @else
                            <img src="{{ asset('default.png') }}" style="border-radius: 50%;" class="mb-3" style="object-fit: cover" width="50" height="50">
                            @endif

                            <div class="ms-3">
                                <a href="{{ route('author.detail', $author->user->slug) }}">
                    ...
                    <form class="d-flex gap-2 mb-3">
                        <div>
                            <div class="input-group">
                                <input type="text" name="name" class="form-control search-chat py-2 px-4 ps-5" placeholder="Search">

                                <svg class="position-absolute top-50 translate-middle-y ms-3" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                ...
                <div class="popular-news-wrap">
                    ...
                    <div class="news-card-five">
                        ...
                        <div class="news-card-info">
                            <h3>
                                <a data-toggle="tooltip" data-placement="top" title="{{ $news->name }}" href="{{ route('news.singlepost', $news->slug) }}">{{ $news->name }}</a>
                            </h3>
                            <p>
