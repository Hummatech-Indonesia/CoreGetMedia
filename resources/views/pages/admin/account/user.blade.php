                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                ...
                                <button title="Detail" data-name="{{ $user->name }}" data-birth="{{ $user->date_of_birth ? $user->date_of_birth : "-" }}" data-address="{{ $user->address ? $user->address : "-" }}" data-image="{{ $user->image ? 'storage/'.$user->image : "default.png" }}" data-email="{{ $user->email }}" class="btn btn-sm btn-primary btn-detail me-2" style="background-color:#5D87FF">
