        ...
        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
            <form class="d-flex">
                <div class="position-relative d-flex">
                    <div class="">
                        <input type="text" name="search" id="search-name" class="form-control search-chat py-2 px-5 ps-5" value="{{ request('search') }}" placeholder="Cari..">
            ...
            <form action="{{route('tag.store.admin')}}" method="post">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" id="tag" name="name" placeholder="Tag" value="{{ old('tag') }}" class="form-control @error('tag') is-invalid @enderror">
                        @error('tag')
                ...
                <div class="modal-footer">
                    <button type="button" style="background-color: #FBF2EF;" class="btn btn-rounded btn-light-danger text-danger" data-bs-dismiss="modal">Batal</button>
...
<div class="table-responsive rounded-2">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="submit" style="background-color: #EF6E6E" class="btn btn-sm text-white btn-delete" data-id="{{$tag->id}}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 24 24">
    ...
    <div class="d-flex justify-content-end">
        <x-paginatoradmin :paginator="$tags" />
    </div>
</div>
            ...
            <form id="form-update" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" id="name-update" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Tags">
                        @error('name')
                        <span class="invalid-feedback" role="alert" style="color: red;">
                            <strong>{{ $message }}</strong>
                        </span>
