...
<h3 class="mb-4">Pilih Halaman</h3>
    ...
    <div class="tab-content">
        ...
        <div id="navpill-222" class="tab-pane fade" role="tabpanel">
            <h3>Halaman Diterima</h3>
            <p>Isi konten untuk tab Diterima di sini.</p>
        </div>

        <!-- Tab Pending -->
        <div id="navpill-333" class="tab-pane fade" role="tabpanel">
            <h3>Halaman Pending</h3>
            <p>Isi konten untuk tab Pending di sini.</p>
        </div>

        <!-- Tab Ditolak -->
        <div id="navpill-444" class="tab-pane fade" role="tabpanel">
            <h3>Halaman Ditolak</h3>
            <p>Isi konten untuk tab Ditolak di sini.</p>
        </div>
    </div>
