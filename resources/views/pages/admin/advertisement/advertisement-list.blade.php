                ...
                @forelse ($data as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            @elseif ($item->feed == 'notpaid')
                                <span class="mb-1 badge rounded-pill font-medium bg-light-danger text-danger w-50">Belum Bayar</span>
                            @elseif ($item->feed == 'published')
                                <span class="mb-1 badge rounded-pill font-medium w-50" style="background-color: #D1DEEA; color: #175A95">Aktif</span>
                            @endif
                        </td>
                        <td>
                            <div class="d-flex gap-2">
                                <a href="{{ route('detail-advertisement', ['advertisement' => $item->id]) }}" data-bs-toggle="tooltip" title="Detail" class="btn btn-sm btn-primary btn-detail me-2" style="background-color:#5D87FF">
