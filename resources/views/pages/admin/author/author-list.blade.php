                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <button data-bs-toggle="tooltip" title="Detail" data-id="{{ $author->id }}" data-name="{{ $author->user->name }}" data-email="{{ $author->user->email }}" class="btn btn-sm btn-detail btn-primary me-2" style="background-color:#5D87FF">
                            ...
                            @if ($author->user->status == 'active')
                                ...
                                <button id="blokir" data-bs-toggle="tooltip" title="Blokir" type="button"  data-id="{{ $author->id }}" class="btn btn-blokir btn-sm btn-danger me-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="25" viewBox="0 0 512 512">
                                        ...
                                        <path fill="none" stroke="#ffffff" stroke-miterlimit="10" stroke-width="32" d="m108.92 108.92l294.16 294.16" /></svg>
                            ...
                            {{-- <form method="post" id="form-unblock">
                                @csrf
                                @method('put') --}}
                                <button id="unblock" data-bs-toggle="tooltip" title="Buka Blokir" type="button" class="btn btn-unblock btn-sm btn-success me-2">
                            ...
                            <a data-bs-toggle="tooltip" title="delete" data-id="{{ $author->id }}" class="btn btn-delete btn-sm btn-danger">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center">
                        <img src="{{ asset($author->user->photo ? 'storage/'.$author->user->photo : "default.png") }}" class="rounded-circle mb-4" id="detail-photo" width="150" alt="photo-siswa" height="150" />
                    </div>
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item" style="font-weight: bold;">Nama : {{ $author->user->name }}<span id="detail-name" style="font-weight: normal;"></span>
                                    </li>
                                    <li class="list-group-item" style="font-weight: bold;">Email: {{ $author->user->email }}<span id="detail-email" style="font-weight: normal;"></span>
                                    </li>
                                </ul>
                            </div>
                            <div class="col">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item" style="font-weight: bold;">Tanggal Lahir: {{ $author->user->date_of_birth ? $author->user->date_of_birth : "-" }}<span id="detail-birth_date" style="font-weight: normal;"></span></li>
...
<script>
    ...
    $('.btn-delete').on('click', function() {
        var id = $(this).data('id');
        $('#form-delete').attr('action', '/author-list/' + id);
        console.log(id);
